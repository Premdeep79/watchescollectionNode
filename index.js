...
async function main() {
    const uri = `mongodb+srv://Prem_deep:Prem123@cluster0.fuiad.mongodb.net/watcheslist?retryWrites=true&w=majority`;
...
async function getDataFromMongo(client) {
    const cursor = client.db("watcheslist").collection("watches")
        .find();
